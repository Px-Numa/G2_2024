...
class Camera:
    ...
    def manage_image_processing(self):
        ...
        while(1):
            ...
            if self.is_start_kensa:
                self.judge_kensa(self.frame_oshidashi, self.output_kensa_image_filepath_upright)
    ...
    def judge_kensa(self, image, path):
        ...
        mask = cv2.imread("image/mask2.jpg", 0)
        ...
        #cv2.imwrite("image/b.jpg", contimg)
    ...
    def read_qr(self, image):
        ...
        print("QRコード読取り")
        try:
            #cv2.imwrite("qrcodes.jpg", frame) # 書き出すcc

            #image = cv2.imread("qrcodes.jpg")
